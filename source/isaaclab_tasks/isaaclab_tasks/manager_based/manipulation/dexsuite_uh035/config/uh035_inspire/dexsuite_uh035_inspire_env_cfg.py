...
from isaaclab_assets.robots import UH035_INSPIRE_LEFT_CFG
#from isaaclab_assets.robots import UH035_INSPIRE_RIGHT_CFG
...
class Uh035MixinCfg:
    ...
    def __post_init__(self: dexsuite.DexsuiteReorientEnvCfg):
        ...
        # HDR20-17 uses "rl_dg_palm", UH035 uses "palm" (under RH56F1_L)
        self.commands.object_pose.body_name = "palm"

        # Robot configuration
        self.scene.robot = UH035_INSPIRE_LEFT_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        finger_tip_body_list = [
            "RH56F1_L/left_thumb_4",    # Thumb collision link (tip parent)
            "RH56F1_L/left_index_2",    # Index collision link
            "RH56F1_L/left_middle_2",   # Middle collision link
            "RH56F1_L/left_ring_2",     # Ring collision link
            "RH56F1_L/left_little_2"    # Little collision link
        ]

        # Create contact sensors for each collision link
        # Sensor names use underscore (e.g., "RH56F1_L_left_thumb_4_object_s")
        # Prim paths use slash (e.g., "{ENV_REGEX_NS}/Robot/RH56F1_L/left_thumb_4")
        ...
        # UH035: ["palm", ".*_tip"] matches thumb_tip, index_tip, middle_tip, ring_tip, little_tip
