...
# - Added object_body_names parameter to track specific body (e.g., left_ring) instead of root
...
class ObjectUniformPoseCommandCfg(CommandTermCfg):
    ...
    - For wire articulation, we track "left_ring" body, not wire_model root.
    """
    ...
    Example: ["left_ring"] to track the hook body instead of wire root.
