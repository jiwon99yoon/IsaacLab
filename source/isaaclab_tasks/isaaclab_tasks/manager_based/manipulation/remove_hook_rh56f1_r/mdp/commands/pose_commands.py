...
# - Added support for tracking specific body (e.g., left_ring) instead of root
...
class ObjectUniformPoseCommand(CommandTerm):
    ...
    MODIFIED for Remove Hook Task:
        ...
        - For wire articulation, tracks "left_ring" body position/orientation.
    """
    ...
    def _update_metrics(self):
        ...
        if self.use_body_tracking:
            # Track specific body (e.g., left_ring for wire articulation)
