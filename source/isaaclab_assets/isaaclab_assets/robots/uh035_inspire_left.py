...
"""Configuration for the UH035 arm with Inspire Hand Left.

The following configurations are available:

* :obj:`UH035_INSPIRE_LEFT_CFG`: UH035 (35kg payload) + Inspire Hand Left (6-DOF under-actuated) with implicit actuator model.
...
# USD 파일 경로 (UH035 + Inspire Hand Left)
# USD_PATH = "/home/dyros/IsaacLab/hyundai/1_factory_usd_file/UH035_usd/UH035_gripper_L.usd"
# USD_PATH = "/home/dyros/IsaacLab/hyundai/1_factory_usd_file/UH035_usd/UH035_gripper_L_withati.usd"
USD_PATH = "/home/dyros/IsaacLab/hyundai/1_factory_usd_file/UH035_usd/UH035_gripper_L_tip_without_ati.usd"
#USD_PATH = "/home/dyros/IsaacLab/hyundai/1_factory_usd_file/UH035_usd/UH035_gripper_L_tip_with_ati.usd"

UH035_INSPIRE_LEFT_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            # === 손 (Hand) - Inspire Left (6 actuated DOF) ===
            # Pre-grasp 자세: 손가락을 적당히 벌리고 약간 굽힌 상태

            # 엄지 (Thumb - 2 actuated joints)
            "left_thumb_1_joint": 0.8,      # 엄지 벌림: [0, 2.0944] 범위 내에서 적당히 벌림
            "left_thumb_2_joint": 0.2,      # 엄지 굽힘: [0, 0.4746] 범위 내에서 살짝 굽힘

            # 검지 (Index - 1 actuated joint, index_2는 mimic)
            "left_index_1_joint": 0.4,      # [0, 1.5286] 범위 내에서 적당히 굽힘

            # 중지 (Middle - 1 actuated joint, middle_2는 mimic)
            "left_middle_1_joint": 0.3,     # [0, 1.5286] 범위 내에서 약간 굽힘

            # 약지 (Ring - 1 actuated joint, ring_2는 mimic)
            "left_ring_1_joint": 0.3,       # [0, 1.5286] 범위 내에서 약간 굽힘

            # 소지 (Little - 1 actuated joint, little_2는 mimic)
            "left_little_1_joint": 0.3,     # [0, 1.5286] 범위 내에서 약간 굽힘
        },
    ),
    ...
    actuators={
        "uh035_inspire_actuators": ImplicitActuatorCfg(
            ...
            stiffness={
                ...
                #       물체에 적응적으로 감싸는 것이 목표
                r"left_thumb_(1|2)_joint": 2.5,             # 엄지: 적당한 강성
                r"left_(index|middle|ring|little)_1_joint": 2.5,  # 나머지 손가락: 동일한 강성
