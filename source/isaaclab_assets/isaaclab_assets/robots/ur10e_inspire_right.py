...
USD_RELATIVE_PATH = "hyundai/1_factory_usd_file/ur10e_usd/ur10e_ati_inspire_right_flattened.usd"
...
UR10E_INSPIRE_RIGHT_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "wrist_2_joint": 3.14159,           # 180° (CHANGED: neutral roll, matching DG5F)
                                                # → Hand palm faces down toward table
            "wrist_3_joint": -3.14159,          # -180° (CHANGED: neutral yaw, matching DG5F)
            ...
            "right_thumb_1_joint": 1.0,      # Thumb abduction: [0, 2.0944] → moderately open
            "right_thumb_2_joint": 0.0,      # Thumb flexion: [0, 0.4746] → slightly bent

            # Index (1 actuated joint, index_2 is mimic)
            "right_index_1_joint": 0.4,      # [0, 1.5286] → moderately bent

            # Middle (1 actuated joint, middle_2 is mimic)
            "right_middle_1_joint": 0.3,     # [0, 1.5286] → slightly bent

            # Ring (1 actuated joint, ring_2 is mimic)
            "right_ring_1_joint": 0.3,       # [0, 1.5286] → slightly bent

            # Little (1 actuated joint, little_2 is mimic)
            "right_little_1_joint": 0.3,     # [0, 1.5286] → slightly bent
        },
    ),
    ...
    actuators={
        "ur10e_inspire_actuators": ImplicitActuatorCfg(
            ...
            stiffness={
                ...
                r"right_thumb_(1|2)_joint": 2.5,             # Thumb: moderate stiffness
                r"right_(index|middle|ring|little)_1_joint": 2.5,  # Fingers: same stiffness
            },
